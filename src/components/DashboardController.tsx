      ...
      <header className="flex flex-col md:flex-row justify-between items-center bg-slate-800/40 backdrop-blur-md p-4 rounded-3xl border border-slate-700/50 shadow-xl gap-4">
        ...
        <div className="flex items-center gap-4 bg-slate-900/80 p-2 pr-4 pl-2 rounded-2xl border border-slate-700 shadow-inner relative group z-10">
          ...
          <div 
            ...
            className="relative flex items-center gap-3 px-4 py-2 rounded-xl hover:bg-white/5 transition-all cursor-pointer"
          >
            ...
            {/* FIX 
                md:pointer-events-none -> Στο Desktop το κλικ "περνάει" από μέσα και χτυπάει το onClick={openCalendar}
                Στο κινητό πιάνει κανονικά το input για να ανοίξει το native wheel.
            */}
            <input 
              ref={dateInputRef}
              type="date" 
